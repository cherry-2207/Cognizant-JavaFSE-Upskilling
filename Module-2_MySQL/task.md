Task: Read the schema.sql and data.sql for understanding the databases and answer the below queries in queries.sql file

Important Note: Write MySQL queries
